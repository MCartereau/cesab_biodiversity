...
tar_target(load_animal_traits, load_csv(pathtraits)),
...
tar_target(select_animal_traits, traits_select(load_animal_traits, c("Mass", "Clutch_MEAN", "Beak.Depth", "Beak.Width", "Tail.Length"))),
